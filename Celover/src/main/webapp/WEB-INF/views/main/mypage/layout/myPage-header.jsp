...
<div class="text-bg-secondary">
	<div class="container">
		<div class="p-4">
			<p class="fw-border" style="font-size: 2rem">${ principal.user.nickname }님 환영합니다 !</p>
			...
			<div class="col-xl-2" id="myPageMenu">
				<div class="panel">
					...
					<ul class="nav flex-column">
						<li class="nav-item d-flex justify-content-between"><a class="nav-link p-3 act">내 정보 수정</a> <i class="fas fa-chevron-right p-2"></i></li>
